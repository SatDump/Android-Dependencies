...
public:  
    ...
    static IConnection *makeConnection_fd(const ConnectionHandle &handle, int fd, bool is_fx3);
...
public:
    ...
    virtual IConnection *make_fd(const ConnectionHandle &handle, int fd) = 0;
