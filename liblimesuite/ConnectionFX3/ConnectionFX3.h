...
public:
    ...
    ConnectionFX3(void* arg, const std::string &vidpid, const std::string &serial, const unsigned index, int fd);
    ~ConnectionFX3(void);

    int Open(const std::string &vidpid, const std::string &serial, const unsigned index);
    int Open_fd(const std::string &vidpid, const std::string &serial, const unsigned index, int fd);
    void Close();
    bool IsOpen();
    int GetOpenedIndex();
